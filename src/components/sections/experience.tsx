...
export default function Experience() {
  return (
    <div className="relative h-screen grid grid-cols-1 md:grid-cols-3 items-center overflow-hidden">
      <div className="h-full col-span-1 md:col-span-2 bg-background relative overflow-hidden">
        <div className="absolute bottom-0 left-0 px-4 space-y-3">
          <GrowExpand
            direction="up"
            size="249px"
            className="shadow-xl w-4 bg-gray-700 dark:bg-gray-50"
          />
        </div>
      </div>
      ...
      <ScrollFade
        direction="right"
        className="h-full col-span-1 animated-background animated-background bg-linear-to-br from-yellow-500 via-cyan-500 to-yellow-500"
      />
